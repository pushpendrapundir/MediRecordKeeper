...
import com.medi.docs.dao.FeedbackDao;
...
public class FeedbackServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String feed=request.getParameter("ffeed");
            
            FeedbackDao dao=new FeedbackDao((Connection) ConnectionProvider.getConnection());
            FeedBack f=new FeedBack(name,email,password,feed);
