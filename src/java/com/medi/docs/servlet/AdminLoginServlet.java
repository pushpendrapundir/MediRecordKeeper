...
import com.medi.docs.dao.AdminDao;
...
public class AdminLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String adminaadhar=request.getParameter("adminloginaadhar");
            String adminpass=request.getParameter("adminloginpass");
            
            
            AdminDao dao=new AdminDao(ConnectionProvider.getConnection());
            Admin a=dao.getAdminByAadharAndPassword(adminaadhar,adminpass);
             if(a==null)
            {
                //login error
