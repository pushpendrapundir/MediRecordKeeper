         ...
         <div class="col-md-2">
            ...
            <div class="col-md-5">
                ...
                <div class="col-md-4" style="color:white;font-size:25px;padding-top:53px;float:right;margin-right:10px;">
                        ...
                        <div class="col-md-10">
                    <h3 style="font-size:25px;padding-top:43px;float:right;margin-right:10px;padding-left:3px;margin-right:-20px"> Find me Here :<br></h3>
                        </div>
                        <div class="col-md-11">
                    <a href="#" style="color:white; float:right;margin-right:15px;padding-top:88px;padding-left:3px;"><i class="fab fa-facebook-square fa-2x" style="float:right;margin-right:-225px;"></i></a>
                    <a  style="color:white; float:right;margin-right:15px;padding-top:88px;" href="#"><i class="fab fa-instagram fa-2x"style="float:right;margin-right:-180px;"></i></a>
                    <a href="#" style="color:white; float:right;margin-right:15px; padding-top:88px;"><i class="fab fa-twitter-square fa-2x"style="float:right;margin-right:-135px;"></i></a>
                      <a href="#" style="color:white; float:right;margin-right:15px; padding-top:88px;"><i class="fab fa-linkedin fa-2x"style="float:right;margin-right:-85px;"></i></a>
                </div>
