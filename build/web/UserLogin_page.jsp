<%-- 
    Document   : UserLogin_page
    Created on : 10-Aug-2020, 12:08:33 AM
    Author     : Windows
--%>
...
<title>User Login Page</title>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
        ...
        <a class="nav-link" href="register_page.jsp" style="color:white;">UserRegister</a>
      </li>
                ...
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <div class="card">
                          ...
                          <div class="card-header"><center><i class="fa fa-user fa-3x" aria-hidden="true"></i></center><center><b>User Login</b></center></div>
  ...
  <div class="form-group " >
    ...
    <input type="text" class="form-control" name="uaadhar" maxlength="12" placeholder="Aadhar Card" required>
    <small id="aadhar" class="form-text text-muted">We'll never share your aadhar with anyone else.</small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Password</label>
    <input type="password" class="form-control" id="exampleInputPassword1" name="upass" placeholder="Password" required>
  </div>
